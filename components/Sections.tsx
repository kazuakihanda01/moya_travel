...
export function Hero() {
  return <section className="hero" id="top">
    <Image
      ...
      alt="雲をまとった山頂と岩肌、その麓に広がる森林"
      fill
      priority
      sizes="100vw"
    />
    <div className="hero-copy">
      <p className="hero-place">MOYA TRAVEL<br />MOGAMI, YAMAGATA / JAPAN</p>
      <h1>最上を、旅する。</h1>
      <p className="tagline">Travel slowly.<br /><em>Stay close to the land.</em></p>
    </div>
  </section>;
}
